...
const Settings = () => {
  ...
  const handleDelete = async (namespace) => {
    try {
      const authToken = await Cookies.get('token')
      const response = await fetch(
        `https://spotless-pear-piglet.cyclic.app/on.cyclic.app/api/deleteNamespace?namespace=${namespace}`,
        {
          method: 'DELETE',
          headers: {
            Authorization: `Bearer ${authToken}`,
  ...
  const handleUpload = async () => {
    ...
    try {
      const authToken = await Cookies.get('token')
      const response = await fetch(
        'https://spotless-pear-piglet.cyclic.app/on.cyclic.app/api/upload',
        {
          method: 'POST',
          body: formData,
          headers: {
  ...
  const handleIngest = async () => {
    try {
      ...
      const authToken = await Cookies.get('token')
      const response = await fetch(
        `https://spotless-pear-piglet.cyclic.app/on.cyclic.app/api/consume?namespaceName=${namespaceName}`,
        {
          method: 'POST',
          headers: {
            Authorization: `Bearer ${authToken}`,
